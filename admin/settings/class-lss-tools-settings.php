...
class Lss_Tools_Settings {
	...
	*/
	public function register_settings() {
		...
		if ( false == get_option( 'lss_tools_settings' ) ) {
			add_option( 'lss_tools_settings', array(), '', 'yes' );
		}
		...
		register_setting( 'lss_tools_settings', 'lss_tools_settings', array( $this->sanitization, 'settings_sanitize' ) );
